...
public class Kidnap extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            Intent intent = new Intent(Kidnap.this,Submited.class);
    ...
    public void onClicksubmit(View view)
    {
        ...
        BackgroundWorker bgworker = new BackgroundWorker(Kidnap.this);
        bgworker.execute("kidnap",un,gn,cn,cd);
