...
public class assault_tbl extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assault_tbl);
    ...
    private void fetchusers()
    {
        class bgWorker extends AsyncTask<String,Void,String>
        {
            ...
            protected String doInBackground(String... strings)
            {
                ...
                {
                    String fetch_url = "http://192.168.1.105/crimeAppDB/as.php";
    ...
    public void logout(View view)
    {
        ...
        editor.commit();
        Intent intent = new Intent(assault_tbl.this,MainActivity.class);
    ...
    {
        Intent intent = new Intent(assault_tbl.this,Admin.class);
        startActivity(intent);
    }
}